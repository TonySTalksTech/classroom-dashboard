...
import { Music, Play, Pause, RotateCcw, Volume2, VolumeX } from 'lucide-react';
...
const Timer: React.FC = () => {
  ...
  const baseSize = Math.min(width / 5, height / 2.5);
  ...
  return (
    <div className="flex flex-col items-center gap-4 h-full">
      <div 
        className={cn(
          "font-mono font-medium tracking-tighter transition-colors",
